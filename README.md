...
In our short time together, we've covered or will soon cover:
...
> You might find [SMART to be a helpful guide](https://focus.admin.ox.ac.uk/files/smartpdf).

Here are some example prompts if you need inspiration:
> *Climate change will disproportionately affect countries at lower sea levels. In anticipation of sea levels rising, you have been hired by a non-profit to identify which countries are most at risk and to report back the top 5 countries where relief and aid should be directed*.
...
In addition, the [Readme Template](./readme-template.md) provides examples and advice for writing a problem statement and structuring your readme file. Note, in order for your readme to automatically display in GitHub, it must be named `README.md`. So, before submitting, make sure to delete this one and replace it with your own!
...
- Start with your **data science problem**.
- Use visuals that are appropriately scaled and interpretable.
- Talk about your procedure/methodology. (Do this at a high level. **CODE IS ALWAYS INAPPROPRIATE FOR A NON-TECHNICAL AUDIENCE**.)
...
- Are there an appropriate number of comments to support the code?
